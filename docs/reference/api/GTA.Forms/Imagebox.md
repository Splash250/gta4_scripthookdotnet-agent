...
For a list of all members of this type, see [Imagebox Members](ImageboxMembers.md).
...
public class Imagebox **: [Control](Control.md)**
...
[Imagebox Members](ImageboxMembers.md) | [GTA.Forms Namespace](index.md)
