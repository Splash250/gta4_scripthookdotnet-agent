...
For a list of all members of this type, see [Checkbox Members](CheckboxMembers.md).
...
public class Checkbox **: [Control](Control.md)**
...
[Checkbox Members](CheckboxMembers.md) | [GTA.Forms Namespace](index.md)
