...
For a list of all members of this type, see [Listbox Members](ListboxMembers.md).
...
public class Listbox **: [Control](Control.md)**
...
[Listbox Members](ListboxMembers.md) | [GTA.Forms Namespace](index.md)
