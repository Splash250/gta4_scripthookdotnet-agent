...
For a list of all members of this type, see [Button Members](ButtonMembers.md).
...
public class Button **: [Control](Control.md)**
...
[Button Members](ButtonMembers.md) | [GTA.Forms Namespace](index.md)
