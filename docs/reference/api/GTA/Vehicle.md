...
- Combine this page with [Entity Model](../../concepts/entity-model.md) and [Sample Projects](../../../examples/sample-projects.md) when tracing how vehicles are created, owned, and released in practice.
