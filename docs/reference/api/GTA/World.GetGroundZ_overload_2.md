...
public static [float](https://learn.microsoft.com/dotnet/api/system.single) GetGroundZ(
   ...
   [GTA.GroundType](GroundType.md) *Type*
);

#### See Also

[World Class](World.md) | [GTA Namespace](index.md) | [World.GetGroundZ Overload List](World.GetGroundZ_overloads.md)
