# ColorIndex Structure

For a list of all members of this type, see [ColorIndex Members](ColorIndexMembers.md).
...
[ColorIndex Members](ColorIndexMembers.md) | [GTA Namespace](index.md)
